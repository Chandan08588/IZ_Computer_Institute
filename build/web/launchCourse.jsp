<%-- 
    Document   : launchCourse
    Created on : Oct 4, 2018, 6:02:03 PM
    Author     : Chandan
--%>
...
<html>
  ...
  <a href="#"  class="active">Launch New Course</a>
  <a href="updatecourse.jsp">Update Course</a>
  <a href="deletecourse.jsp">Delete Course</a>
  <a href="reviewers.jsp">Reviewers</a>
</div>
                    </div>
                    <div class="col-md-10 launchCourse">
                        <h2>Launch New Course</h2> 
<!--                        <form class="form-group" action="#" method="post">
                            <input type="text" placeholder="Course Name" style="width: 50%">
