<%-- 
    Document   : adminLogin
    Created on : Oct 2, 2018, 5:53:18 PM
    Author     : Chandan
--%>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row adminLogin">
                <div class="col-md-12"> <center>  <h1 id="title">Admin Pannel</h1></center></div>
                    <hr>
                    <div class="col-md-4"></div>
                    <div class="col-md-4 login">
                        <center>  <h1 id="title">Hii Admin !</h1></center>
                        <form action="loginfo.jsp" method="post" class="form-group">
                            <label for="AdminId">Admin Id: </label>
                            <input type="text" class="form-control" name="uadmin" placeholder="@admin_id"required>
