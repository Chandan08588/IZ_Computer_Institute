<%-- 
    Document   : contact_us
    Created on : Oct 1, 2018, 7:29:26 PM
    Author     : Chandan
--%>
...
<html>
    <head>
        ...
        <title>I.Z.Computer_Institute</title>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row contact_us">
                <div class="col-md-12"> <center>  <h1 id="title">Contact Us</h1></center></div>
                    <hr>
                <div class="col-md-6 address">
                    ...
                    <center>
                        <h2>Address :</h2>
                        <p>
                            <span>I.Z. Computer Institute, </span> Near City Public School<br>
                            Mohalla Salar, Nayaganj, City: Rudauli , Disttrict Faizabad <br>
                            Uttar Pradesh, India <br>
                            Pin 224116<br>
                            <span> Contact : </span> +91 90055 68427 <br>
                            <span> Email : </span>  izcomputerinstitute@gmail.com <br>
                            <span> Alternative Email : </span>izcomputer@gmail.com <br>
                        </p>
                ...
                <div class="col-md-6">
                    <div class=" sir">
                    <center><img src="images/sir.jpg" alt="Aakif Qumail" >
                    <h2>Manager</h2>
                        <p>+91 99352 28083</p>
                        <p>qumailaakif@gmail.com</p> <br></center>
                    </div>
                </div>
